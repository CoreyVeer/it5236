...
class Application {
    ...
    public function register($username, $password, $email, $registrationcode, &$errors) {
          ...
          if (sizeof($errors) == 0) {
  			...
  			curl_setopt($ch, CURLOPT_HTTPHEADER, array('x-api-key: 0QLqThwhecaeGojldPSPX18l5mYaKrOK6ILwMdOU', 'Content-Type: application/json','Content-Length: ' . strlen($data_json)));
      ...
      protected function sendVerificationEmail($userid, $email, &$errors) {
          ...
          if ($result === FALSE) {
              ...
              $message = "A request has been made to login to your account at https://russellthackston.me. ".
                  "If you did not make this request, please ignore this message. No other action is necessary. ".
                  "To confirm your login, please use this validation code: $validationid";
